...
def infer(args):
    ...
    questions = ["When was Beyonce born?", "What areas did Beyonce compete in when she was growing up?", "When did Beyonce leave Destiny's Child and become a solo singer?", "Which popular girl-group was Beyonce the lead singer of?", "Which Beyonce songs were featured on the Billboard Hot 100 number-one singles list?"]
