...
def main(raw_args=None):
    ...
    command_job = command(
        ...
        # ),
        environment=Environment(
            description="ACPT DistilBERT fine-tune environment", image="azureml://locations/eastus/workspaces/3f9aec1f-8bce-45dd-9358-bb5750b6f300/environments/prathikrao-test-env/versions/1"
        ),
        distribution={
            "type": "pytorch",
